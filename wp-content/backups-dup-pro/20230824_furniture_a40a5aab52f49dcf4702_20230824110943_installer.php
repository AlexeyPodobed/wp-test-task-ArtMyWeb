...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20230824_furniture_a40a5aab52f49dcf4702_20230824110943_archive.zip';
    const ARCHIVE_SIZE       = '41802086';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'a40a5aa-24110943';
    const SECONDARY_PACKAGE_HASH = 'af7eae2-24110943';
    const VERSION            = '3.8.9.1';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.9.1==');
        $this->log('----------------------------------------------------');
